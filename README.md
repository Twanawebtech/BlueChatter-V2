...
2_1 Requirements
---------
1. An IBM Bluemix account. Either [sign up][bluemix_signup_url], or use an existing account.
...
1. If you have not already, [download node.js 6.9.1 or later][https://nodejs.org/download/] and install it on your local machine.
